...
#define ONBOARDING_VERSION "1.8.0.0"

#define BRIGHTNESS_LEVEL        "BrightnessLevel"
#define ACTION_SET_ON           "SetOn"
#define ACTION_SET_OFF          "SetOff"
#define ACTION_SET_MOVIE        "SetMovie"
#define ACTION_SET_READING      "SetReading"
#define ACTION_SET_SLEEP        "SetSleep"
#define ACTION_SET_BRIGHTNESS   "SetBrightnessLevel"


extern int brightness_level;
extern int light_control_state;
